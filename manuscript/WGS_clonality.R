...
#"Pembro mamma 140-290"
perc_clonal_290.p = my_wilcoxon(clin.df %>% dplyr::filter(Cohort_trueHML == "HML > 290"), "perc_clon",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab(">290")
perc_clonal_290.p

perc_clonal_breast_140_290.p = my_wilcoxon(clin.df %>% dplyr::filter(Cohort_trueHML %in% c("HML 140-290, breast","HML 140-290, other")), "perc_clon",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab("140-290")
perc_clonal_breast_140_290.p

#
cTML_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(Cohort_trueHML == "HML > 290"), "cTML_maftools_05",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab(">290 cohort")
cTML_290_cohort.p

cTML_breast_140_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(Cohort_trueHML %in% c("HML 140-290, breast","HML 140-290, other")), "cTML_maftools_05",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab("140-290 cohort")
cTML_breast_140_290_cohort.p
#
...
perc_clonal_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(cohort_manuscript == "Pembro HML>290"), "perc_clon",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab(">290 cohort")
perc_clonal_140_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(cohort_manuscript == "Pembro 140-290"), "perc_clon",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab("140-290 cohort")
...
cTML_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(cohort_manuscript == "Pembro HML>290"), "cTML",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab(">290 cohort")
cTML_140_290_cohort.p = my_wilcoxon(clin.df %>% dplyr::filter(cohort_manuscript == "Pembro 140-290"), "cTML",pval_ypos = 110)+
  theme(axis.title.x = element_text()) + 
  xlab("140-290 cohort")
...
layout = c("AAABD
            ...
            AAAHJ")
perc_clon_scatter.p+
  perc_clonal_140_290.p +cTML_140_290.p+
  perc_clonal_290.p     +cTML_290.p+
  perc_clonal_breast.p +cTMLal_breast.p+
...
layout = c("ABCD
           EFGH
           IJ##")
perc_clonal_140_290.p+  perc_clonal_140_290_cohort.p+ cTML_140_290.p+ cTML_140_290_cohort.p+
  perc_clonal_290.p+  perc_clonal_290_cohort.p+ cTML_290.p+ cTML_290_cohort.p+
  perc_clonal_breast.p +cTMLal_breast.p+
  plot_layout(design = layout)
